...
/*Мини-игра, цель которой показать, что алкоголизм - это плохо. Мы создаём страничку main.php под игру.
...
$_GET['module'] = 'static'; //папка "modules/static/" c файлами: main.php и .tpl, main.php и .tpl,...
...
include './libs/class_Mail.php'; //в main.php
...
Кнопка 'Удалить' видна только тем, у кого есть права = 5
...
27.4 Внешние и внутренние админки
