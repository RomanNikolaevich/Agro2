...
в браузер (у Chrome, Firefox. IE, ... у всех свой). Поэтому на этапе тестирования уже нужно проверять наши страницы
в разных броузерах, включая мобильные броузеры, чтобы быть уверенным, что пользователи увидят вашу страницу так, как
вы задумывали.
