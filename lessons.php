...
33.2 Основы JS
JS работает в html. PHP тоже может работать в HTML, но его мы можем открыть в любом месте HTML страницы. Код JS
всегда располагается внизу html и содержится внутри блока:
<script> </script>
